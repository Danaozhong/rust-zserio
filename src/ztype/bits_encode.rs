...
pub fn write_uint64(writer: &mut BitWriter, v: u64) {
    write_unsigned_bits(writer, v, 64);
}
pub fn write_uint32(writer: &mut BitWriter, v: u32) {
    write_unsigned_bits(writer, v as u64, 32);
}
pub fn write_uint16(writer: &mut BitWriter, v: u16) {
    write_unsigned_bits(writer, v as u64, 16);
}
pub fn write_uint8(writer: &mut BitWriter, v: u8) {
    write_unsigned_bits(writer, v as u64, 8);
}

pub fn write_int64(writer: &mut BitWriter, v: i64) {
    writer.write_i64(v, 64).expect("failed to write i64");
}
pub fn write_int32(writer: &mut BitWriter, v: i32) {
    writer.write_i32(v, 32).expect("failed to write i32");
}
pub fn write_int16(writer: &mut BitWriter, v: i16) {
    writer.write_i16(v, 16).expect("failed to write i16");
}
pub fn write_int8(writer: &mut BitWriter, v: i8) {
