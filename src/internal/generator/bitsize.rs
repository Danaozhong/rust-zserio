...
pub fn bitsize_type_reference(function: &mut Function, field_name: &str, is_marshaler: bool, type_reference: &TypeReference) {
    if is_marshaler {
        function.line(format!("end_position += {}.zserio_bitsize(end_position);", field_name));
    } else {
    if type_reference.bits != 0 {
        function.line(format!("end_position += {};", type_reference.bits));
    } else {
        match type_reference.name.as_str() {
            "uint8" => { function.line("end_position += 8;"); },
            "uint16" => { function.line("end_position += 16;"); },
            "uint32" => { function.line("end_position += 32;"); },
            "uint64" => { function.line("end_position += 64;"); },
            "int8" => { function.line("end_position += 8;"); },
            "int16" => { function.line("end_position += 16;"); },
            "int32" => { function.line("end_position += 32;"); },
            "int64" => { function.line("end_position += 64;"); },
            "float16" => { function.line("end_position += 16;"); },
            ...
            "varint64" => { function.line(format!("end_position += ztype::signed_bit_size({});", field_name)); },
            "varuint" => { function.line(format!("end_position += ztype::unsigned_bit_size({});", field_name)); },
            "varuint16" => { function.line(format!("end_position += ztype::unsigned_bit_size({});", field_name)); },
            "varuint32" => { function.line(format!("end_position += ztype::unsigned_bit_size({});", field_name)); },
            "varuint64" => { function.line(format!("end_position += ztype::unsigned_bit_size({});", field_name)); },
            _ => panic!("failed"),
        }
    }
}
