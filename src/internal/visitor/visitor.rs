...
use crate::internal::parser::gen::zserioparservisitor::{
    ZserioParserVisitorCompat,
};

use crate::internal::parser::gen::zserioparser::{
    ZserioParserContextType,
    TemplateParametersContext,
    TemplateParametersContextAttrs,
    ImportDeclarationContext,
    ImportDeclarationContextAttrs,
    IdContext,
    QualifiedNameContext,
    PackageNameDefinitionContext,
    PackageNameDefinitionContextAttrs,
    StructureDeclarationContext,
    StructureDeclarationContextAttrs,
    EnumDeclarationContext,
    EnumDeclarationContextAttrs,
    EnumItemContext,
    EnumItemContextAttrs,
    PackageDeclarationContext,
    PackageDeclarationContextAttrs,
    FieldTypeIdContext,
    FieldTypeIdContextAttrs,
    TypeInstantiationContext,
    TypeInstantiationContextAttrs,
    StructureFieldDefinitionContext, StructureFieldDefinitionContextAttrs, TypeReferenceContext, TypeReferenceContextAttrs,
    

};
use antlr_rust::parser_rule_context::ParserRuleContext;
use antlr_rust::token::Token;
use antlr_rust::tree::{ErrorNode, ParseTree, ParseTreeVisitorCompat, TerminalNode, Visitable, Tree};
...
impl Default for ZserioTreeReturnType {
    fn default() -> Self { ZserioTreeReturnType::Str("".into())}
}
...
impl ParseTreeVisitorCompat<'_> for Visitor {
    ...
    fn aggregate_results(
        ...
        match aggregate {
            ...
            _ => {
                final_return_types.push(aggregate)
            },
        }
        match next {
            ZserioTreeReturnType::Vec(mut v) => {
...
impl ZserioParserVisitorCompat<'_> for Visitor {
                ...
                ZserioTreeReturnType::Vec(v) => {
                    for ve in v {
                        match ve {
                            ...
                            ZserioTreeReturnType::StrVec(s) => println!("unknown str vec: {0}", s[0]),
                            ZserioTreeReturnType::TypeReference(z) => println!("unknown type ref: {0}", z.bits),
    ...
    fn visit_packageNameDefinition(&mut self, ctx: &PackageNameDefinitionContext<'_>) -> Self::Return {
        let mut ids = Vec::new();
    ...
    fn visit_structureDeclaration(&mut self, ctx: &StructureDeclarationContext<'_>) -> Self::Return { 
    ...
    fn visit_fieldTypeId(&mut self, ctx: &FieldTypeIdContext<'_>) -> Self::Return {   
        ...
        match ZserioParserVisitorCompat::visit_typeInstantiation(self, &*ctx.typeInstantiation().unwrap()) {
            ZserioTreeReturnType::TypeReference(t) => type_reference = t,
            _ => panic!("should not happen"),
        }
        ZserioTreeReturnType::Field(Box::new(Field { name: field_name.clone(), zserio_name: field_name, comment: "".into(), is_optional: false, alignment: 0, field_type: type_reference }))
    }
