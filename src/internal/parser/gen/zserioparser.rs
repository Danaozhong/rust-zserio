...
use std::any::{Any,TypeId};
		...
		pub const ENUM:isize=41; 
		pub const EXPLICIT:isize=42; 
		pub const EXTERN:isize=43; 
		pub const FLOAT16:isize=44; 
		pub const FLOAT32:isize=45; 
		pub const FLOAT64:isize=46; 
		pub const FUNCTION:isize=47; 
		pub const IF:isize=48; 
		pub const IMPLICIT:isize=49; 
		pub const IMPORT:isize=50; 
		pub const INDEX:isize=51; 
		pub const INSTANTIATE:isize=52; 
		pub const INT_FIELD:isize=53; 
		pub const INT16:isize=54; 
		pub const INT32:isize=55; 
		pub const INT64:isize=56; 
		pub const INT8:isize=57; 
		pub const ISSET:isize=58; 
		pub const LENGTHOF:isize=59; 
		pub const NUMBITS:isize=60; 
		pub const ON:isize=61; 
		pub const OPTIONAL:isize=62; 
		pub const PACKAGE:isize=63; 
		pub const PACKED:isize=64; 
		pub const PUBSUB:isize=65; 
		pub const PUBLISH:isize=66; 
		pub const RETURN:isize=67; 
		pub const RULE:isize=68; 
		pub const RULE_GROUP:isize=69; 
		pub const SERVICE:isize=70; 
		pub const SQL:isize=71; 
		pub const SQL_DATABASE:isize=72; 
		pub const SQL_TABLE:isize=73; 
		pub const SQL_VIRTUAL:isize=74; 
		pub const SQL_WITHOUT_ROWID:isize=75; 
		pub const STRING:isize=76; 
		pub const STRUCTURE:isize=77; 
		pub const SUBSCRIBE:isize=78; 
		pub const SUBTYPE:isize=79; 
		pub const TOPIC:isize=80; 
		pub const UINT16:isize=81; 
		pub const UINT32:isize=82; 
		pub const UINT64:isize=83; 
		pub const UINT8:isize=84; 
		pub const UNION:isize=85; 
		pub const USING:isize=86; 
		pub const VALUEOF:isize=87; 
		pub const VARINT:isize=88; 
		pub const VARINT16:isize=89; 
		pub const VARINT32:isize=90; 
		pub const VARINT64:isize=91; 
		pub const VARSIZE:isize=92; 
		pub const VARUINT:isize=93; 
		pub const VARUINT16:isize=94; 
		pub const VARUINT32:isize=95; 
		pub const VARUINT64:isize=96; 
		pub const COMPAT_VERSION:isize=97; 
		pub const WS:isize=98; 
		pub const DOC_COMMENT:isize=99; 
		pub const MARKDOWN_COMMENT:isize=100; 
		pub const BLOCK_COMMENT:isize=101; 
		pub const LINE_COMMENT:isize=102; 
		pub const BOOL_LITERAL:isize=103; 
		pub const STRING_LITERAL:isize=104; 
		pub const BINARY_LITERAL:isize=105; 
		pub const OCTAL_LITERAL:isize=106; 
		pub const HEXADECIMAL_LITERAL:isize=107; 
		pub const DOUBLE_LITERAL:isize=108; 
		pub const FLOAT_LITERAL:isize=109; 
		pub const DECIMAL_LITERAL:isize=110; 
		pub const ID:isize=111; 
		pub const INVALID_STRING_LITERAL:isize=112; 
		pub const INVALID_TOKEN:isize=113; 
		pub const RSHIFT:isize=114;
	...
	pub const _LITERAL_NAMES: [Option<&'static str>;98] = [
		...
		Some("'const'"), Some("'default'"), Some("'enum'"), Some("'explicit'"), 
		Some("'extern'"), Some("'float16'"), Some("'float32'"), Some("'float64'"), 
		Some("'function'"), Some("'if'"), Some("'implicit'"), Some("'import'"), 
		Some("'@index'"), Some("'instantiate'"), Some("'int'"), Some("'int16'"), 
		Some("'int32'"), Some("'int64'"), Some("'int8'"), Some("'isset'"), Some("'lengthof'"), 
		Some("'numbits'"), Some("'on'"), Some("'optional'"), Some("'package'"), 
		Some("'packed'"), Some("'pubsub'"), Some("'publish'"), Some("'return'"), 
		Some("'rule'"), Some("'rule_group'"), Some("'service'"), Some("'sql'"), 
	...
	pub const _SYMBOLIC_NAMES: [Option<&'static str>;115]  = [
		...
		Some("ENUM"), Some("EXPLICIT"), Some("EXTERN"), Some("FLOAT16"), Some("FLOAT32"), 
		Some("FLOAT64"), Some("FUNCTION"), Some("IF"), Some("IMPLICIT"), Some("IMPORT"), 
		Some("INDEX"), Some("INSTANTIATE"), Some("INT_FIELD"), Some("INT16"), 
		Some("INT32"), Some("INT64"), Some("INT8"), Some("ISSET"), Some("LENGTHOF"), 
		Some("NUMBITS"), Some("ON"), Some("OPTIONAL"), Some("PACKAGE"), Some("PACKED"), 
		Some("PUBSUB"), Some("PUBLISH"), Some("RETURN"), Some("RULE"), Some("RULE_GROUP"), 
		Some("SERVICE"), Some("SQL"), Some("SQL_DATABASE"), Some("SQL_TABLE"), 
		Some("SQL_VIRTUAL"), Some("SQL_WITHOUT_ROWID"), Some("STRING"), Some("STRUCTURE"), 
		Some("SUBSCRIBE"), Some("SUBTYPE"), Some("TOPIC"), Some("UINT16"), Some("UINT32"), 
		Some("UINT64"), Some("UINT8"), Some("UNION"), Some("USING"), Some("VALUEOF"), 
		Some("VARINT"), Some("VARINT16"), Some("VARINT32"), Some("VARINT64"), 
		Some("VARSIZE"), Some("VARUINT"), Some("VARUINT16"), Some("VARUINT32"), 
		Some("VARUINT64"), Some("COMPAT_VERSION"), Some("WS"), Some("DOC_COMMENT"), 
		...
		Some("INVALID_TOKEN"), Some("RSHIFT")
	];
	lazy_static!{
...
type BaseParserType<'input, I> =
	BaseParser<'input,ZserioParserExt<'input>, I, ZserioParserContextType , dyn ZserioParserListener<'input> + 'input >;
...
impl<'input,I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>> ParserRecog<'input, BaseParserType<'input,I>> for ZserioParserExt<'input>{}

impl<'input,I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>> Actions<'input, BaseParserType<'input,I>> for ZserioParserExt<'input>{
	fn get_grammar_file_name(&self) -> & str{ "ZserioParser.g4"}

   	fn get_rule_names(&self) -> &[& str] {&ruleNames}

   	fn get_vocabulary(&self) -> &dyn Vocabulary { &**VOCABULARY }
	fn sempred(_localctx: Option<&(dyn ZserioParserContext<'input> + 'input)>, rule_index: isize, pred_index: isize,
			   recog:&mut BaseParserType<'input,I>
	)->bool{
		match rule_index {
					53 => ZserioParser::<'input,I,_>::expression_sempred(_localctx.and_then(|x|x.downcast_ref()), pred_index, recog),
			_ => true
		}
	}
}
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for PackageDeclarationContext<'input>{
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for PackageDeclarationContext<'input>{
...
impl<'input> PackageDeclarationContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<PackageDeclarationContextAll<'input>> {
		Rc::new(
...
pub trait PackageDeclarationContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<PackageDeclarationContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token EOF
/// Returns `None` if there is no child corresponding to token EOF
fn EOF(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
	self.get_token(EOF, 0)
}
fn compatibilityVersionDirective(&self) -> Option<Rc<CompatibilityVersionDirectiveContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn packageNameDefinition(&self) -> Option<Rc<PackageNameDefinitionContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
fn languageDirective_all(&self) ->  Vec<Rc<LanguageDirectiveContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn languageDirective(&self, i: usize) -> Option<Rc<LanguageDirectiveContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<PackageDeclarationContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 0, RULE_packageDeclaration);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.err_handler.sync(&mut recog.base)?;
			_la = recog.base.input.la(1);
			while ((((_la - 35)) & !0x3f) == 0 && ((1usize << (_la - 35)) & ((1usize << (BITMASK - 35)) | (1usize << (CHOICE - 35)) | (1usize << (CONST - 35)) | (1usize << (ENUM - 35)) | (1usize << (INSTANTIATE - 35)) | (1usize << (PUBSUB - 35)))) != 0) || ((((_la - 69)) & !0x3f) == 0 && ((1usize << (_la - 69)) & ((1usize << (RULE_GROUP - 69)) | (1usize << (SERVICE - 69)) | (1usize << (SQL_DATABASE - 69)) | (1usize << (SQL_TABLE - 69)) | (1usize << (STRUCTURE - 69)) | (1usize << (SUBTYPE - 69)) | (1usize << (UNION - 69)))) != 0) {
				{
				{
...
pub type CompatibilityVersionDirectiveContextAll<'input> = CompatibilityVersionDirectiveContext<'input>;


pub type CompatibilityVersionDirectiveContext<'input> = BaseParserRuleContext<'input,CompatibilityVersionDirectiveContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for CompatibilityVersionDirectiveContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for CompatibilityVersionDirectiveContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for CompatibilityVersionDirectiveContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_compatibilityVersionDirective }
...
impl<'input> CompatibilityVersionDirectiveContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<CompatibilityVersionDirectiveContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,CompatibilityVersionDirectiveContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait CompatibilityVersionDirectiveContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<CompatibilityVersionDirectiveContextExt<'input>>{
...
fn COMPAT_VERSION(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
	self.get_token(COMPAT_VERSION, 0)
}
/// Retrieves first TerminalNode corresponding to token LPAREN
/// Returns `None` if there is no child corresponding to token LPAREN
fn LPAREN(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn STRING_LITERAL(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
	self.get_token(STRING_LITERAL, 0)
}
/// Retrieves first TerminalNode corresponding to token RPAREN
/// Returns `None` if there is no child corresponding to token RPAREN
fn RPAREN(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn SEMICOLON(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
	self.get_token(SEMICOLON, 0)
}

}

impl<'input> CompatibilityVersionDirectiveContextAttrs<'input> for CompatibilityVersionDirectiveContext<'input>{}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn compatibilityVersionDirective(&mut self,)
	-> Result<Rc<CompatibilityVersionDirectiveContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = CompatibilityVersionDirectiveContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 2, RULE_compatibilityVersionDirective);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.base.match_token(COMPAT_VERSION,&mut recog.err_handler)?;
...
pub type PackageNameDefinitionContext<'input> = BaseParserRuleContext<'input,PackageNameDefinitionContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for PackageNameDefinitionContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for PackageNameDefinitionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for PackageNameDefinitionContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_packageNameDefinition }
...
impl<'input> PackageNameDefinitionContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<PackageNameDefinitionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,PackageNameDefinitionContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait PackageNameDefinitionContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<PackageNameDefinitionContextExt<'input>>{
...
fn PACKAGE(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn DOT_all(&self) -> Vec<Rc<TerminalNode<'input,ZserioParserContextType>>>  where Self:Sized{
	self.get_tokens(DOT)
}
/// Retrieves 'i's TerminalNode corresponding to token DOT, starting from 0.
/// Returns `None` if number of children corresponding to token DOT is less or equal than `i`.
fn DOT(&self, i: usize) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn packageNameDefinition(&mut self,)
	-> Result<Rc<PackageNameDefinitionContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = PackageNameDefinitionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 4, RULE_packageNameDefinition);
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for ImportDeclarationContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for ImportDeclarationContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> ImportDeclarationContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ImportDeclarationContextAll<'input>> {
		Rc::new(
...
pub trait ImportDeclarationContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<ImportDeclarationContextExt<'input>>{
...
fn IMPORT(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn MULTIPLY(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<ImportDeclarationContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 6, RULE_importDeclaration);
...
pub type LanguageDirectiveContext<'input> = BaseParserRuleContext<'input,LanguageDirectiveContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for LanguageDirectiveContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for LanguageDirectiveContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for LanguageDirectiveContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_languageDirective }
...
impl<'input> LanguageDirectiveContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<LanguageDirectiveContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,LanguageDirectiveContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait LanguageDirectiveContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<LanguageDirectiveContextExt<'input>>{

fn symbolDefinition(&self) -> Option<Rc<SymbolDefinitionContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn typeDeclaration(&self) -> Option<Rc<TypeDeclarationContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn languageDirective(&mut self,)
	-> Result<Rc<LanguageDirectiveContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = LanguageDirectiveContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 8, RULE_languageDirective);
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for TypeDeclarationContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for TypeDeclarationContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> TypeDeclarationContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<TypeDeclarationContextAll<'input>> {
		Rc::new(
...
pub trait TypeDeclarationContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<TypeDeclarationContextExt<'input>>{

fn subtypeDeclaration(&self) -> Option<Rc<SubtypeDeclarationContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn structureDeclaration(&self) -> Option<Rc<StructureDeclarationContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn choiceDeclaration(&self) -> Option<Rc<ChoiceDeclarationContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn unionDeclaration(&self) -> Option<Rc<UnionDeclarationContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn enumDeclaration(&self) -> Option<Rc<EnumDeclarationContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn bitmaskDeclaration(&self) -> Option<Rc<BitmaskDeclarationContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn sqlTableDeclaration(&self) -> Option<Rc<SqlTableDeclarationContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn sqlDatabaseDefinition(&self) -> Option<Rc<SqlDatabaseDefinitionContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn serviceDefinition(&self) -> Option<Rc<ServiceDefinitionContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn pubsubDefinition(&self) -> Option<Rc<PubsubDefinitionContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn instantiateDeclaration(&self) -> Option<Rc<InstantiateDeclarationContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<TypeDeclarationContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 10, RULE_typeDeclaration);
...
pub type SymbolDefinitionContext<'input> = BaseParserRuleContext<'input,SymbolDefinitionContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for SymbolDefinitionContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for SymbolDefinitionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for SymbolDefinitionContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_symbolDefinition }
...
impl<'input> SymbolDefinitionContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<SymbolDefinitionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,SymbolDefinitionContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait SymbolDefinitionContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<SymbolDefinitionContextExt<'input>>{

fn constDefinition(&self) -> Option<Rc<ConstDefinitionContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn ruleGroupDefinition(&self) -> Option<Rc<RuleGroupDefinitionContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn symbolDefinition(&mut self,)
	-> Result<Rc<SymbolDefinitionContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = SymbolDefinitionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 12, RULE_symbolDefinition);
...
pub type ConstDefinitionContext<'input> = BaseParserRuleContext<'input,ConstDefinitionContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for ConstDefinitionContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for ConstDefinitionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for ConstDefinitionContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_constDefinition }
...
impl<'input> ConstDefinitionContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ConstDefinitionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,ConstDefinitionContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait ConstDefinitionContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<ConstDefinitionContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token CONST
/// Returns `None` if there is no child corresponding to token CONST
fn CONST(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
	self.get_token(CONST, 0)
}
fn typeInstantiation(&self) -> Option<Rc<TypeInstantiationContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
fn ASSIGN(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn constDefinition(&mut self,)
	-> Result<Rc<ConstDefinitionContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = ConstDefinitionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 14, RULE_constDefinition);
...
pub type RuleGroupDefinitionContext<'input> = BaseParserRuleContext<'input,RuleGroupDefinitionContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for RuleGroupDefinitionContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for RuleGroupDefinitionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for RuleGroupDefinitionContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_ruleGroupDefinition }
...
impl<'input> RuleGroupDefinitionContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<RuleGroupDefinitionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,RuleGroupDefinitionContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait RuleGroupDefinitionContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<RuleGroupDefinitionContextExt<'input>>{
...
fn RULE_GROUP(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn LBRACE(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn RBRACE(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn ruleDefinition_all(&self) ->  Vec<Rc<RuleDefinitionContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn ruleDefinition(&self, i: usize) -> Option<Rc<RuleDefinitionContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn ruleGroupDefinition(&mut self,)
	-> Result<Rc<RuleGroupDefinitionContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = RuleGroupDefinitionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 16, RULE_ruleGroupDefinition);
...
pub type RuleDefinitionContext<'input> = BaseParserRuleContext<'input,RuleDefinitionContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for RuleDefinitionContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for RuleDefinitionContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_ruleDefinition }
...
impl<'input> RuleDefinitionContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<RuleDefinitionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,RuleDefinitionContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait RuleDefinitionContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<RuleDefinitionContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token RULE
/// Returns `None` if there is no child corresponding to token RULE
fn RULE(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn ruleDefinition(&mut self,)
	-> Result<Rc<RuleDefinitionContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = RuleDefinitionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 18, RULE_ruleDefinition);
...
pub type SubtypeDeclarationContext<'input> = BaseParserRuleContext<'input,SubtypeDeclarationContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for SubtypeDeclarationContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for SubtypeDeclarationContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for SubtypeDeclarationContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_subtypeDeclaration }
...
impl<'input> SubtypeDeclarationContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<SubtypeDeclarationContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,SubtypeDeclarationContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait SubtypeDeclarationContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<SubtypeDeclarationContextExt<'input>>{
...
fn SUBTYPE(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn subtypeDeclaration(&mut self,)
	-> Result<Rc<SubtypeDeclarationContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = SubtypeDeclarationContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 20, RULE_subtypeDeclaration);
...
pub type StructureDeclarationContext<'input> = BaseParserRuleContext<'input,StructureDeclarationContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for StructureDeclarationContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for StructureDeclarationContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for StructureDeclarationContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_structureDeclaration }
...
impl<'input> StructureDeclarationContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<StructureDeclarationContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,StructureDeclarationContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait StructureDeclarationContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<StructureDeclarationContextExt<'input>>{
...
fn STRUCTURE(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn templateParameters(&self) -> Option<Rc<TemplateParametersContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn typeParameters(&self) -> Option<Rc<TypeParametersContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn structureFieldDefinition_all(&self) ->  Vec<Rc<StructureFieldDefinitionContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn structureFieldDefinition(&self, i: usize) -> Option<Rc<StructureFieldDefinitionContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn structureDeclaration(&mut self,)
	-> Result<Rc<StructureDeclarationContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = StructureDeclarationContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 22, RULE_structureDeclaration);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.err_handler.sync(&mut recog.base)?;
			_la = recog.base.input.la(1);
			while (((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << BANG) | (1usize << LPAREN) | (1usize << MINUS) | (1usize << PLUS) | (1usize << TILDE))) != 0) || ((((_la - 32)) & !0x3f) == 0 && ((1usize << (_la - 32)) & ((1usize << (ALIGN - 32)) | (1usize << (BIT_FIELD - 32)) | (1usize << (BOOL - 32)) | (1usize << (BYTES - 32)) | (1usize << (EXTERN - 32)) | (1usize << (FLOAT16 - 32)) | (1usize << (FLOAT32 - 32)) | (1usize << (FLOAT64 - 32)) | (1usize << (IMPLICIT - 32)) | (1usize << (INDEX - 32)) | (1usize << (INT_FIELD - 32)) | (1usize << (INT16 - 32)) | (1usize << (INT32 - 32)) | (1usize << (INT64 - 32)) | (1usize << (INT8 - 32)) | (1usize << (ISSET - 32)) | (1usize << (LENGTHOF - 32)) | (1usize << (NUMBITS - 32)) | (1usize << (OPTIONAL - 32)))) != 0) || ((((_la - 64)) & !0x3f) == 0 && ((1usize << (_la - 64)) & ((1usize << (PACKED - 64)) | (1usize << (STRING - 64)) | (1usize << (UINT16 - 64)) | (1usize << (UINT32 - 64)) | (1usize << (UINT64 - 64)) | (1usize << (UINT8 - 64)) | (1usize << (VALUEOF - 64)) | (1usize << (VARINT - 64)) | (1usize << (VARINT16 - 64)) | (1usize << (VARINT32 - 64)) | (1usize << (VARINT64 - 64)) | (1usize << (VARSIZE - 64)) | (1usize << (VARUINT - 64)) | (1usize << (VARUINT16 - 64)) | (1usize << (VARUINT32 - 64)))) != 0) || ((((_la - 96)) & !0x3f) == 0 && ((1usize << (_la - 96)) & ((1usize << (VARUINT64 - 96)) | (1usize << (BOOL_LITERAL - 96)) | (1usize << (STRING_LITERAL - 96)) | (1usize << (BINARY_LITERAL - 96)) | (1usize << (OCTAL_LITERAL - 96)) | (1usize << (HEXADECIMAL_LITERAL - 96)) | (1usize << (DOUBLE_LITERAL - 96)) | (1usize << (FLOAT_LITERAL - 96)) | (1usize << (DECIMAL_LITERAL - 96)) | (1usize << (ID - 96)))) != 0) {
				{
				{
...
pub type StructureFieldDefinitionContext<'input> = BaseParserRuleContext<'input,StructureFieldDefinitionContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for StructureFieldDefinitionContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for StructureFieldDefinitionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for StructureFieldDefinitionContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_structureFieldDefinition }
...
impl<'input> StructureFieldDefinitionContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<StructureFieldDefinitionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,StructureFieldDefinitionContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait StructureFieldDefinitionContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<StructureFieldDefinitionContextExt<'input>>{

fn fieldTypeId(&self) -> Option<Rc<FieldTypeIdContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token SEMICOLON
/// Returns `None` if there is no child corresponding to token SEMICOLON
...
fn fieldAlignment(&self) -> Option<Rc<FieldAlignmentContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn fieldOffset(&self) -> Option<Rc<FieldOffsetContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
fn OPTIONAL(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
	self.get_token(OPTIONAL, 0)
}
fn fieldInitializer(&self) -> Option<Rc<FieldInitializerContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn fieldOptionalClause(&self) -> Option<Rc<FieldOptionalClauseContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn fieldConstraint(&self) -> Option<Rc<FieldConstraintContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}

}

impl<'input> StructureFieldDefinitionContextAttrs<'input> for StructureFieldDefinitionContext<'input>{}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn structureFieldDefinition(&mut self,)
	-> Result<Rc<StructureFieldDefinitionContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = StructureFieldDefinitionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 24, RULE_structureFieldDefinition);
...
pub type FieldAlignmentContext<'input> = BaseParserRuleContext<'input,FieldAlignmentContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for FieldAlignmentContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for FieldAlignmentContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_fieldAlignment }
...
impl<'input> FieldAlignmentContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<FieldAlignmentContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,FieldAlignmentContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait FieldAlignmentContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<FieldAlignmentContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token ALIGN
/// Returns `None` if there is no child corresponding to token ALIGN
fn ALIGN(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn COLON(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn fieldAlignment(&mut self,)
	-> Result<Rc<FieldAlignmentContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = FieldAlignmentContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 26, RULE_fieldAlignment);
...
impl<'input> CustomRuleContext<'input> for FieldOffsetContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_fieldOffset }
...
impl<'input> FieldOffsetContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<FieldOffsetContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,FieldOffsetContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait FieldOffsetContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<FieldOffsetContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn fieldOffset(&mut self,)
	-> Result<Rc<FieldOffsetContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = FieldOffsetContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 28, RULE_fieldOffset);
...
impl<'input> CustomRuleContext<'input> for FieldTypeIdContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_fieldTypeId }
...
impl<'input> FieldTypeIdContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<FieldTypeIdContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,FieldTypeIdContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait FieldTypeIdContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<FieldTypeIdContextExt<'input>>{
...
fn PACKED(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn IMPLICIT(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
	self.get_token(IMPLICIT, 0)
}
fn fieldArrayRange(&self) -> Option<Rc<FieldArrayRangeContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn fieldTypeId(&mut self,)
	-> Result<Rc<FieldTypeIdContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = FieldTypeIdContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 30, RULE_fieldTypeId);
...
pub type FieldArrayRangeContext<'input> = BaseParserRuleContext<'input,FieldArrayRangeContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for FieldArrayRangeContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for FieldArrayRangeContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for FieldArrayRangeContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_fieldArrayRange }
...
impl<'input> FieldArrayRangeContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<FieldArrayRangeContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,FieldArrayRangeContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait FieldArrayRangeContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<FieldArrayRangeContextExt<'input>>{
...
fn LBRACKET(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn RBRACKET(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn fieldArrayRange(&mut self,)
	-> Result<Rc<FieldArrayRangeContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = FieldArrayRangeContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 32, RULE_fieldArrayRange);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.err_handler.sync(&mut recog.base)?;
			_la = recog.base.input.la(1);
			if (((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << BANG) | (1usize << LPAREN) | (1usize << MINUS) | (1usize << PLUS) | (1usize << TILDE))) != 0) || ((((_la - 51)) & !0x3f) == 0 && ((1usize << (_la - 51)) & ((1usize << (INDEX - 51)) | (1usize << (ISSET - 51)) | (1usize << (LENGTHOF - 51)) | (1usize << (NUMBITS - 51)))) != 0) || ((((_la - 87)) & !0x3f) == 0 && ((1usize << (_la - 87)) & ((1usize << (VALUEOF - 87)) | (1usize << (BOOL_LITERAL - 87)) | (1usize << (STRING_LITERAL - 87)) | (1usize << (BINARY_LITERAL - 87)) | (1usize << (OCTAL_LITERAL - 87)) | (1usize << (HEXADECIMAL_LITERAL - 87)) | (1usize << (DOUBLE_LITERAL - 87)) | (1usize << (FLOAT_LITERAL - 87)) | (1usize << (DECIMAL_LITERAL - 87)) | (1usize << (ID - 87)))) != 0) {
				{
				/*InvokeRule expression*/
...
pub type FieldInitializerContext<'input> = BaseParserRuleContext<'input,FieldInitializerContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for FieldInitializerContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for FieldInitializerContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for FieldInitializerContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_fieldInitializer }
...
impl<'input> FieldInitializerContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<FieldInitializerContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,FieldInitializerContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait FieldInitializerContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<FieldInitializerContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn fieldInitializer(&mut self,)
	-> Result<Rc<FieldInitializerContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = FieldInitializerContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 34, RULE_fieldInitializer);
...
pub type FieldOptionalClauseContext<'input> = BaseParserRuleContext<'input,FieldOptionalClauseContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for FieldOptionalClauseContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for FieldOptionalClauseContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for FieldOptionalClauseContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_fieldOptionalClause }
...
impl<'input> FieldOptionalClauseContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<FieldOptionalClauseContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,FieldOptionalClauseContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait FieldOptionalClauseContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<FieldOptionalClauseContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token IF
/// Returns `None` if there is no child corresponding to token IF
fn IF(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
	self.get_token(IF, 0)
}
fn expression(&self) -> Option<Rc<ExpressionContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn fieldOptionalClause(&mut self,)
	-> Result<Rc<FieldOptionalClauseContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = FieldOptionalClauseContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 36, RULE_fieldOptionalClause);
...
pub type FieldConstraintContext<'input> = BaseParserRuleContext<'input,FieldConstraintContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for FieldConstraintContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for FieldConstraintContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for FieldConstraintContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_fieldConstraint }
...
impl<'input> FieldConstraintContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<FieldConstraintContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,FieldConstraintContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait FieldConstraintContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<FieldConstraintContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn fieldConstraint(&mut self,)
	-> Result<Rc<FieldConstraintContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = FieldConstraintContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 38, RULE_fieldConstraint);
...
pub type ChoiceDeclarationContext<'input> = BaseParserRuleContext<'input,ChoiceDeclarationContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for ChoiceDeclarationContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for ChoiceDeclarationContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for ChoiceDeclarationContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_choiceDeclaration }
...
impl<'input> ChoiceDeclarationContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ChoiceDeclarationContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,ChoiceDeclarationContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait ChoiceDeclarationContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<ChoiceDeclarationContextExt<'input>>{
...
fn CHOICE(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn ON(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
	self.get_token(ON, 0)
}
fn expression(&self) -> Option<Rc<ExpressionContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
...
fn choiceCases_all(&self) ->  Vec<Rc<ChoiceCasesContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn choiceCases(&self, i: usize) -> Option<Rc<ChoiceCasesContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
fn choiceDefault(&self) -> Option<Rc<ChoiceDefaultContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn functionDefinition_all(&self) ->  Vec<Rc<FunctionDefinitionContextAll<'input>>> where Self:Sized{
	self.children_of_type()
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn choiceDeclaration(&mut self,)
	-> Result<Rc<ChoiceDeclarationContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = ChoiceDeclarationContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 40, RULE_choiceDeclaration);
...
impl<'input> CustomRuleContext<'input> for ChoiceCasesContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_choiceCases }
...
impl<'input> ChoiceCasesContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ChoiceCasesContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,ChoiceCasesContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait ChoiceCasesContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<ChoiceCasesContextExt<'input>>{
...
fn choiceCase_all(&self) ->  Vec<Rc<ChoiceCaseContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn choiceCase(&self, i: usize) -> Option<Rc<ChoiceCaseContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
fn choiceFieldDefinition(&self) -> Option<Rc<ChoiceFieldDefinitionContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn choiceCases(&mut self,)
	-> Result<Rc<ChoiceCasesContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = ChoiceCasesContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 42, RULE_choiceCases);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.err_handler.sync(&mut recog.base)?;
			_la = recog.base.input.la(1);
			if ((((_la - 33)) & !0x3f) == 0 && ((1usize << (_la - 33)) & ((1usize << (BIT_FIELD - 33)) | (1usize << (BOOL - 33)) | (1usize << (BYTES - 33)) | (1usize << (EXTERN - 33)) | (1usize << (FLOAT16 - 33)) | (1usize << (FLOAT32 - 33)) | (1usize << (FLOAT64 - 33)) | (1usize << (IMPLICIT - 33)) | (1usize << (INT_FIELD - 33)) | (1usize << (INT16 - 33)) | (1usize << (INT32 - 33)) | (1usize << (INT64 - 33)) | (1usize << (INT8 - 33)) | (1usize << (PACKED - 33)))) != 0) || ((((_la - 76)) & !0x3f) == 0 && ((1usize << (_la - 76)) & ((1usize << (STRING - 76)) | (1usize << (UINT16 - 76)) | (1usize << (UINT32 - 76)) | (1usize << (UINT64 - 76)) | (1usize << (UINT8 - 76)) | (1usize << (VARINT - 76)) | (1usize << (VARINT16 - 76)) | (1usize << (VARINT32 - 76)) | (1usize << (VARINT64 - 76)) | (1usize << (VARSIZE - 76)) | (1usize << (VARUINT - 76)) | (1usize << (VARUINT16 - 76)) | (1usize << (VARUINT32 - 76)) | (1usize << (VARUINT64 - 76)))) != 0) || _la==ID {
				{
...
impl<'input> CustomRuleContext<'input> for ChoiceCaseContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_choiceCase }
...
impl<'input> ChoiceCaseContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ChoiceCaseContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,ChoiceCaseContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait ChoiceCaseContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<ChoiceCaseContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token CASE
/// Returns `None` if there is no child corresponding to token CASE
fn CASE(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn choiceCase(&mut self,)
	-> Result<Rc<ChoiceCaseContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = ChoiceCaseContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 44, RULE_choiceCase);
...
pub type ChoiceDefaultContext<'input> = BaseParserRuleContext<'input,ChoiceDefaultContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for ChoiceDefaultContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for ChoiceDefaultContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_choiceDefault }
...
impl<'input> ChoiceDefaultContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ChoiceDefaultContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,ChoiceDefaultContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait ChoiceDefaultContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<ChoiceDefaultContextExt<'input>>{
...
fn DEFAULT(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn choiceDefault(&mut self,)
	-> Result<Rc<ChoiceDefaultContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = ChoiceDefaultContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 46, RULE_choiceDefault);
...
pub type ChoiceFieldDefinitionContext<'input> = BaseParserRuleContext<'input,ChoiceFieldDefinitionContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for ChoiceFieldDefinitionContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for ChoiceFieldDefinitionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for ChoiceFieldDefinitionContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_choiceFieldDefinition }
...
impl<'input> ChoiceFieldDefinitionContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ChoiceFieldDefinitionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,ChoiceFieldDefinitionContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait ChoiceFieldDefinitionContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<ChoiceFieldDefinitionContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn choiceFieldDefinition(&mut self,)
	-> Result<Rc<ChoiceFieldDefinitionContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = ChoiceFieldDefinitionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 48, RULE_choiceFieldDefinition);
...
pub type UnionDeclarationContext<'input> = BaseParserRuleContext<'input,UnionDeclarationContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for UnionDeclarationContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for UnionDeclarationContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for UnionDeclarationContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_unionDeclaration }
...
impl<'input> UnionDeclarationContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<UnionDeclarationContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,UnionDeclarationContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait UnionDeclarationContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<UnionDeclarationContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token UNION
/// Returns `None` if there is no child corresponding to token UNION
fn UNION(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn unionFieldDefinition_all(&self) ->  Vec<Rc<UnionFieldDefinitionContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn unionFieldDefinition(&self, i: usize) -> Option<Rc<UnionFieldDefinitionContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
fn functionDefinition_all(&self) ->  Vec<Rc<FunctionDefinitionContextAll<'input>>> where Self:Sized{
	self.children_of_type()
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn unionDeclaration(&mut self,)
	-> Result<Rc<UnionDeclarationContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = UnionDeclarationContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 50, RULE_unionDeclaration);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.err_handler.sync(&mut recog.base)?;
			_la = recog.base.input.la(1);
			while ((((_la - 33)) & !0x3f) == 0 && ((1usize << (_la - 33)) & ((1usize << (BIT_FIELD - 33)) | (1usize << (BOOL - 33)) | (1usize << (BYTES - 33)) | (1usize << (EXTERN - 33)) | (1usize << (FLOAT16 - 33)) | (1usize << (FLOAT32 - 33)) | (1usize << (FLOAT64 - 33)) | (1usize << (IMPLICIT - 33)) | (1usize << (INT_FIELD - 33)) | (1usize << (INT16 - 33)) | (1usize << (INT32 - 33)) | (1usize << (INT64 - 33)) | (1usize << (INT8 - 33)) | (1usize << (PACKED - 33)))) != 0) || ((((_la - 76)) & !0x3f) == 0 && ((1usize << (_la - 76)) & ((1usize << (STRING - 76)) | (1usize << (UINT16 - 76)) | (1usize << (UINT32 - 76)) | (1usize << (UINT64 - 76)) | (1usize << (UINT8 - 76)) | (1usize << (VARINT - 76)) | (1usize << (VARINT16 - 76)) | (1usize << (VARINT32 - 76)) | (1usize << (VARINT64 - 76)) | (1usize << (VARSIZE - 76)) | (1usize << (VARUINT - 76)) | (1usize << (VARUINT16 - 76)) | (1usize << (VARUINT32 - 76)) | (1usize << (VARUINT64 - 76)))) != 0) || _la==ID {
				{
				{
...
pub type UnionFieldDefinitionContext<'input> = BaseParserRuleContext<'input,UnionFieldDefinitionContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for UnionFieldDefinitionContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for UnionFieldDefinitionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for UnionFieldDefinitionContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_unionFieldDefinition }
...
impl<'input> UnionFieldDefinitionContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<UnionFieldDefinitionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,UnionFieldDefinitionContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait UnionFieldDefinitionContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<UnionFieldDefinitionContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn unionFieldDefinition(&mut self,)
	-> Result<Rc<UnionFieldDefinitionContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = UnionFieldDefinitionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 52, RULE_unionFieldDefinition);
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for EnumDeclarationContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for EnumDeclarationContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> EnumDeclarationContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<EnumDeclarationContextAll<'input>> {
		Rc::new(
...
pub trait EnumDeclarationContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<EnumDeclarationContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token ENUM
/// Returns `None` if there is no child corresponding to token ENUM
fn ENUM(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn enumItem_all(&self) ->  Vec<Rc<EnumItemContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn enumItem(&self, i: usize) -> Option<Rc<EnumItemContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves first TerminalNode corresponding to token RBRACE
/// Returns `None` if there is no child corresponding to token RBRACE
...
fn COMMA_all(&self) -> Vec<Rc<TerminalNode<'input,ZserioParserContextType>>>  where Self:Sized{
	self.get_tokens(COMMA)
}
/// Retrieves 'i's TerminalNode corresponding to token COMMA, starting from 0.
/// Returns `None` if number of children corresponding to token COMMA is less or equal than `i`.
fn COMMA(&self, i: usize) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<EnumDeclarationContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 54, RULE_enumDeclaration);
...
impl<'input> CustomRuleContext<'input> for EnumItemContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_enumItem }
...
impl<'input> EnumItemContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<EnumItemContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,EnumItemContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait EnumItemContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<EnumItemContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn enumItem(&mut self,)
	-> Result<Rc<EnumItemContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type BitmaskDeclarationContext<'input> = BaseParserRuleContext<'input,BitmaskDeclarationContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for BitmaskDeclarationContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for BitmaskDeclarationContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for BitmaskDeclarationContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_bitmaskDeclaration }
...
impl<'input> BitmaskDeclarationContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<BitmaskDeclarationContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,BitmaskDeclarationContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait BitmaskDeclarationContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<BitmaskDeclarationContextExt<'input>>{
...
fn BITMASK(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn bitmaskValue_all(&self) ->  Vec<Rc<BitmaskValueContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn bitmaskValue(&self, i: usize) -> Option<Rc<BitmaskValueContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves first TerminalNode corresponding to token RBRACE
/// Returns `None` if there is no child corresponding to token RBRACE
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn bitmaskDeclaration(&mut self,)
	-> Result<Rc<BitmaskDeclarationContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = BitmaskDeclarationContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 58, RULE_bitmaskDeclaration);
...
pub type BitmaskValueContext<'input> = BaseParserRuleContext<'input,BitmaskValueContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for BitmaskValueContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_bitmaskValue }
...
impl<'input> BitmaskValueContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<BitmaskValueContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,BitmaskValueContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait BitmaskValueContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<BitmaskValueContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn bitmaskValue(&mut self,)
	-> Result<Rc<BitmaskValueContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = BitmaskValueContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 60, RULE_bitmaskValue);
...
pub type SqlTableDeclarationContext<'input> = BaseParserRuleContext<'input,SqlTableDeclarationContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for SqlTableDeclarationContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for SqlTableDeclarationContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for SqlTableDeclarationContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_sqlTableDeclaration }
...
impl<'input> SqlTableDeclarationContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<SqlTableDeclarationContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,SqlTableDeclarationContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait SqlTableDeclarationContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<SqlTableDeclarationContextExt<'input>>{
...
fn SQL_TABLE(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn USING(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
	self.get_token(USING, 0)
}
fn sqlTableFieldDefinition_all(&self) ->  Vec<Rc<SqlTableFieldDefinitionContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn sqlTableFieldDefinition(&self, i: usize) -> Option<Rc<SqlTableFieldDefinitionContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
fn sqlConstraintDefinition(&self) -> Option<Rc<SqlConstraintDefinitionContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn sqlWithoutRowId(&self) -> Option<Rc<SqlWithoutRowIdContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn sqlTableDeclaration(&mut self,)
	-> Result<Rc<SqlTableDeclarationContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = SqlTableDeclarationContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 62, RULE_sqlTableDeclaration);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.err_handler.sync(&mut recog.base)?;
			_la = recog.base.input.la(1);
			while ((((_la - 33)) & !0x3f) == 0 && ((1usize << (_la - 33)) & ((1usize << (BIT_FIELD - 33)) | (1usize << (BOOL - 33)) | (1usize << (BYTES - 33)) | (1usize << (EXTERN - 33)) | (1usize << (FLOAT16 - 33)) | (1usize << (FLOAT32 - 33)) | (1usize << (FLOAT64 - 33)) | (1usize << (INT_FIELD - 33)) | (1usize << (INT16 - 33)) | (1usize << (INT32 - 33)) | (1usize << (INT64 - 33)) | (1usize << (INT8 - 33)))) != 0) || ((((_la - 74)) & !0x3f) == 0 && ((1usize << (_la - 74)) & ((1usize << (SQL_VIRTUAL - 74)) | (1usize << (STRING - 74)) | (1usize << (UINT16 - 74)) | (1usize << (UINT32 - 74)) | (1usize << (UINT64 - 74)) | (1usize << (UINT8 - 74)) | (1usize << (VARINT - 74)) | (1usize << (VARINT16 - 74)) | (1usize << (VARINT32 - 74)) | (1usize << (VARINT64 - 74)) | (1usize << (VARSIZE - 74)) | (1usize << (VARUINT - 74)) | (1usize << (VARUINT16 - 74)) | (1usize << (VARUINT32 - 74)) | (1usize << (VARUINT64 - 74)))) != 0) || _la==ID {
				{
				{
...
pub type SqlTableFieldDefinitionContext<'input> = BaseParserRuleContext<'input,SqlTableFieldDefinitionContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for SqlTableFieldDefinitionContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for SqlTableFieldDefinitionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for SqlTableFieldDefinitionContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_sqlTableFieldDefinition }
...
impl<'input> SqlTableFieldDefinitionContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<SqlTableFieldDefinitionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,SqlTableFieldDefinitionContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait SqlTableFieldDefinitionContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<SqlTableFieldDefinitionContextExt<'input>>{
...
fn SQL_VIRTUAL(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
	self.get_token(SQL_VIRTUAL, 0)
}
fn sqlConstraint(&self) -> Option<Rc<SqlConstraintContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}

}

impl<'input> SqlTableFieldDefinitionContextAttrs<'input> for SqlTableFieldDefinitionContext<'input>{}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn sqlTableFieldDefinition(&mut self,)
	-> Result<Rc<SqlTableFieldDefinitionContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = SqlTableFieldDefinitionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 64, RULE_sqlTableFieldDefinition);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			if _la==SQL_VIRTUAL {
				...
				recog.base.match_token(SQL_VIRTUAL,&mut recog.err_handler)?;
...
pub type SqlConstraintDefinitionContext<'input> = BaseParserRuleContext<'input,SqlConstraintDefinitionContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for SqlConstraintDefinitionContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for SqlConstraintDefinitionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for SqlConstraintDefinitionContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_sqlConstraintDefinition }
...
impl<'input> SqlConstraintDefinitionContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<SqlConstraintDefinitionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,SqlConstraintDefinitionContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait SqlConstraintDefinitionContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<SqlConstraintDefinitionContextExt<'input>>{
...
impl<'input> SqlConstraintDefinitionContextAttrs<'input> for SqlConstraintDefinitionContext<'input>{}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn sqlConstraintDefinition(&mut self,)
	-> Result<Rc<SqlConstraintDefinitionContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = SqlConstraintDefinitionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 66, RULE_sqlConstraintDefinition);
...
pub type SqlConstraintContext<'input> = BaseParserRuleContext<'input,SqlConstraintContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for SqlConstraintContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for SqlConstraintContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_sqlConstraint }
...
impl<'input> SqlConstraintContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<SqlConstraintContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,SqlConstraintContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait SqlConstraintContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<SqlConstraintContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token SQL
/// Returns `None` if there is no child corresponding to token SQL
fn SQL(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn sqlConstraint(&mut self,)
	-> Result<Rc<SqlConstraintContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = SqlConstraintContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 68, RULE_sqlConstraint);
...
pub type SqlWithoutRowIdContext<'input> = BaseParserRuleContext<'input,SqlWithoutRowIdContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for SqlWithoutRowIdContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for SqlWithoutRowIdContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for SqlWithoutRowIdContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_sqlWithoutRowId }
...
impl<'input> SqlWithoutRowIdContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<SqlWithoutRowIdContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,SqlWithoutRowIdContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait SqlWithoutRowIdContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<SqlWithoutRowIdContextExt<'input>>{
...
fn SQL_WITHOUT_ROWID(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn sqlWithoutRowId(&mut self,)
	-> Result<Rc<SqlWithoutRowIdContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = SqlWithoutRowIdContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 70, RULE_sqlWithoutRowId);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.base.match_token(SQL_WITHOUT_ROWID,&mut recog.err_handler)?;
...
pub type SqlDatabaseDefinitionContext<'input> = BaseParserRuleContext<'input,SqlDatabaseDefinitionContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for SqlDatabaseDefinitionContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for SqlDatabaseDefinitionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for SqlDatabaseDefinitionContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_sqlDatabaseDefinition }
...
impl<'input> SqlDatabaseDefinitionContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<SqlDatabaseDefinitionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,SqlDatabaseDefinitionContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait SqlDatabaseDefinitionContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<SqlDatabaseDefinitionContextExt<'input>>{
...
fn SQL_DATABASE(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn sqlDatabaseFieldDefinition_all(&self) ->  Vec<Rc<SqlDatabaseFieldDefinitionContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn sqlDatabaseFieldDefinition(&self, i: usize) -> Option<Rc<SqlDatabaseFieldDefinitionContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn sqlDatabaseDefinition(&mut self,)
	-> Result<Rc<SqlDatabaseDefinitionContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = SqlDatabaseDefinitionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 72, RULE_sqlDatabaseDefinition);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.base.match_token(SQL_DATABASE,&mut recog.err_handler)?;
			...
			loop {
				...
				recog.err_handler.sync(&mut recog.base)?;
				_la = recog.base.input.la(1);
				if !(((((_la - 33)) & !0x3f) == 0 && ((1usize << (_la - 33)) & ((1usize << (BIT_FIELD - 33)) | (1usize << (BOOL - 33)) | (1usize << (BYTES - 33)) | (1usize << (EXTERN - 33)) | (1usize << (FLOAT16 - 33)) | (1usize << (FLOAT32 - 33)) | (1usize << (FLOAT64 - 33)) | (1usize << (INT_FIELD - 33)) | (1usize << (INT16 - 33)) | (1usize << (INT32 - 33)) | (1usize << (INT64 - 33)) | (1usize << (INT8 - 33)))) != 0) || ((((_la - 76)) & !0x3f) == 0 && ((1usize << (_la - 76)) & ((1usize << (STRING - 76)) | (1usize << (UINT16 - 76)) | (1usize << (UINT32 - 76)) | (1usize << (UINT64 - 76)) | (1usize << (UINT8 - 76)) | (1usize << (VARINT - 76)) | (1usize << (VARINT16 - 76)) | (1usize << (VARINT32 - 76)) | (1usize << (VARINT64 - 76)) | (1usize << (VARSIZE - 76)) | (1usize << (VARUINT - 76)) | (1usize << (VARUINT16 - 76)) | (1usize << (VARUINT32 - 76)) | (1usize << (VARUINT64 - 76)))) != 0) || _la==ID) {break}
			}
...
pub type SqlDatabaseFieldDefinitionContext<'input> = BaseParserRuleContext<'input,SqlDatabaseFieldDefinitionContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for SqlDatabaseFieldDefinitionContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for SqlDatabaseFieldDefinitionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for SqlDatabaseFieldDefinitionContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_sqlDatabaseFieldDefinition }
...
impl<'input> SqlDatabaseFieldDefinitionContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<SqlDatabaseFieldDefinitionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,SqlDatabaseFieldDefinitionContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait SqlDatabaseFieldDefinitionContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<SqlDatabaseFieldDefinitionContextExt<'input>>{
...
impl<'input> SqlDatabaseFieldDefinitionContextAttrs<'input> for SqlDatabaseFieldDefinitionContext<'input>{}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn sqlDatabaseFieldDefinition(&mut self,)
	-> Result<Rc<SqlDatabaseFieldDefinitionContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = SqlDatabaseFieldDefinitionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 74, RULE_sqlDatabaseFieldDefinition);
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for ServiceDefinitionContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for ServiceDefinitionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> ServiceDefinitionContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ServiceDefinitionContextAll<'input>> {
		Rc::new(
...
pub trait ServiceDefinitionContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<ServiceDefinitionContextExt<'input>>{
...
fn SERVICE(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn serviceMethodDefinition_all(&self) ->  Vec<Rc<ServiceMethodDefinitionContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn serviceMethodDefinition(&self, i: usize) -> Option<Rc<ServiceMethodDefinitionContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<ServiceDefinitionContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 76, RULE_serviceDefinition);
...
pub type ServiceMethodDefinitionContext<'input> = BaseParserRuleContext<'input,ServiceMethodDefinitionContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for ServiceMethodDefinitionContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for ServiceMethodDefinitionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for ServiceMethodDefinitionContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_serviceMethodDefinition }
...
impl<'input> ServiceMethodDefinitionContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ServiceMethodDefinitionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,ServiceMethodDefinitionContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait ServiceMethodDefinitionContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<ServiceMethodDefinitionContextExt<'input>>{

fn typeReference_all(&self) ->  Vec<Rc<TypeReferenceContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn typeReference(&self, i: usize) -> Option<Rc<TypeReferenceContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
fn id(&self) -> Option<Rc<IdContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
...
impl<'input> ServiceMethodDefinitionContextAttrs<'input> for ServiceMethodDefinitionContext<'input>{}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn serviceMethodDefinition(&mut self,)
	-> Result<Rc<ServiceMethodDefinitionContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = ServiceMethodDefinitionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 78, RULE_serviceMethodDefinition);
...
pub type PubsubDefinitionContext<'input> = BaseParserRuleContext<'input,PubsubDefinitionContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for PubsubDefinitionContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for PubsubDefinitionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for PubsubDefinitionContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_pubsubDefinition }
...
impl<'input> PubsubDefinitionContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<PubsubDefinitionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,PubsubDefinitionContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait PubsubDefinitionContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<PubsubDefinitionContextExt<'input>>{
...
fn PUBSUB(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn pubsubMessageDefinition_all(&self) ->  Vec<Rc<PubsubMessageDefinitionContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn pubsubMessageDefinition(&self, i: usize) -> Option<Rc<PubsubMessageDefinitionContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn pubsubDefinition(&mut self,)
	-> Result<Rc<PubsubDefinitionContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = PubsubDefinitionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 80, RULE_pubsubDefinition);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.err_handler.sync(&mut recog.base)?;
			_la = recog.base.input.la(1);
			while ((((_la - 66)) & !0x3f) == 0 && ((1usize << (_la - 66)) & ((1usize << (PUBLISH - 66)) | (1usize << (SUBSCRIBE - 66)) | (1usize << (TOPIC - 66)))) != 0) {
				{
				{
...
pub type PubsubMessageDefinitionContext<'input> = BaseParserRuleContext<'input,PubsubMessageDefinitionContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for PubsubMessageDefinitionContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for PubsubMessageDefinitionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for PubsubMessageDefinitionContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_pubsubMessageDefinition }
...
impl<'input> PubsubMessageDefinitionContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<PubsubMessageDefinitionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,PubsubMessageDefinitionContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait PubsubMessageDefinitionContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<PubsubMessageDefinitionContextExt<'input>>{

fn topicDefinition(&self) -> Option<Rc<TopicDefinitionContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn typeReference(&self) -> Option<Rc<TypeReferenceContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
...
impl<'input> PubsubMessageDefinitionContextAttrs<'input> for PubsubMessageDefinitionContext<'input>{}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn pubsubMessageDefinition(&mut self,)
	-> Result<Rc<PubsubMessageDefinitionContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = PubsubMessageDefinitionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 82, RULE_pubsubMessageDefinition);
...
pub type TopicDefinitionContext<'input> = BaseParserRuleContext<'input,TopicDefinitionContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for TopicDefinitionContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for TopicDefinitionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for TopicDefinitionContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_topicDefinition }
...
impl<'input> TopicDefinitionContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<TopicDefinitionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,TopicDefinitionContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait TopicDefinitionContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<TopicDefinitionContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token TOPIC
/// Returns `None` if there is no child corresponding to token TOPIC
fn TOPIC(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn PUBLISH(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn SUBSCRIBE(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn topicDefinition(&mut self,)
	-> Result<Rc<TopicDefinitionContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = TopicDefinitionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 84, RULE_topicDefinition);
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for FunctionDefinitionContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for FunctionDefinitionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> FunctionDefinitionContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<FunctionDefinitionContextAll<'input>> {
		Rc::new(
...
pub trait FunctionDefinitionContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<FunctionDefinitionContextExt<'input>>{
...
fn FUNCTION(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<FunctionDefinitionContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 86, RULE_functionDefinition);
...
impl<'input> FunctionTypeContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<FunctionTypeContextAll<'input>> {
		Rc::new(
...
pub trait FunctionTypeContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<FunctionTypeContextExt<'input>>{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<FunctionTypeContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 88, RULE_functionType);
...
impl<'input> FunctionNameContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<FunctionNameContextAll<'input>> {
		Rc::new(
...
pub trait FunctionNameContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<FunctionNameContextExt<'input>>{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<FunctionNameContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 90, RULE_functionName);
...
impl<'input> FunctionBodyContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<FunctionBodyContextAll<'input>> {
		Rc::new(
...
pub trait FunctionBodyContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<FunctionBodyContextExt<'input>>{
...
fn RETURN(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<FunctionBodyContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 92, RULE_functionBody);
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for TypeParametersContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> TypeParametersContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<TypeParametersContextAll<'input>> {
		Rc::new(
...
pub trait TypeParametersContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<TypeParametersContextExt<'input>>{
...
fn parameterDefinition_all(&self) ->  Vec<Rc<ParameterDefinitionContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn parameterDefinition(&self, i: usize) -> Option<Rc<ParameterDefinitionContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves first TerminalNode corresponding to token RPAREN
/// Returns `None` if there is no child corresponding to token RPAREN
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<TypeParametersContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 94, RULE_typeParameters);
...
pub type ParameterDefinitionContext<'input> = BaseParserRuleContext<'input,ParameterDefinitionContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for ParameterDefinitionContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for ParameterDefinitionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for ParameterDefinitionContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_parameterDefinition }
...
impl<'input> ParameterDefinitionContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ParameterDefinitionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,ParameterDefinitionContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait ParameterDefinitionContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<ParameterDefinitionContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn parameterDefinition(&mut self,)
	-> Result<Rc<ParameterDefinitionContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = ParameterDefinitionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 96, RULE_parameterDefinition);
...
pub type TemplateParametersContext<'input> = BaseParserRuleContext<'input,TemplateParametersContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for TemplateParametersContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for TemplateParametersContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for TemplateParametersContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_templateParameters }
...
impl<'input> TemplateParametersContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<TemplateParametersContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,TemplateParametersContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait TemplateParametersContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<TemplateParametersContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token LT
/// Returns `None` if there is no child corresponding to token LT
fn LT(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
	self.get_token(LT, 0)
}
fn id_all(&self) ->  Vec<Rc<IdContextAll<'input>>> where Self:Sized{
	self.children_of_type()
...
fn GT(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
	self.get_token(GT, 0)
}
/// Retrieves all `TerminalNode`s corresponding to token COMMA in current rule
fn COMMA_all(&self) -> Vec<Rc<TerminalNode<'input,ZserioParserContextType>>>  where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn templateParameters(&mut self,)
	-> Result<Rc<TemplateParametersContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = TemplateParametersContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 98, RULE_templateParameters);
...
pub type TemplateArgumentsContext<'input> = BaseParserRuleContext<'input,TemplateArgumentsContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for TemplateArgumentsContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for TemplateArgumentsContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for TemplateArgumentsContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_templateArguments }
...
impl<'input> TemplateArgumentsContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<TemplateArgumentsContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,TemplateArgumentsContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait TemplateArgumentsContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<TemplateArgumentsContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn templateArguments(&mut self,)
	-> Result<Rc<TemplateArgumentsContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = TemplateArgumentsContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 100, RULE_templateArguments);
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for TemplateArgumentContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for TemplateArgumentContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> TemplateArgumentContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<TemplateArgumentContextAll<'input>> {
		Rc::new(
...
pub trait TemplateArgumentContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<TemplateArgumentContextExt<'input>>{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<TemplateArgumentContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 102, RULE_templateArgument);
...
pub type InstantiateDeclarationContext<'input> = BaseParserRuleContext<'input,InstantiateDeclarationContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for InstantiateDeclarationContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for InstantiateDeclarationContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for InstantiateDeclarationContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_instantiateDeclaration }
...
impl<'input> InstantiateDeclarationContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<InstantiateDeclarationContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,InstantiateDeclarationContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait InstantiateDeclarationContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<InstantiateDeclarationContextExt<'input>>{
...
fn INSTANTIATE(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn instantiateDeclaration(&mut self,)
	-> Result<Rc<InstantiateDeclarationContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = InstantiateDeclarationContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 104, RULE_instantiateDeclaration);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			recog.base.match_token(INSTANTIATE,&mut recog.err_handler)?;
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for ExpressionContextAll<'input>{
	fn accept(&self, visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) { self.deref().accept(visitor) }
}
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for ExpressionContextAll<'input>{
    fn enter(&self, listener: &mut (dyn ZserioParserListener<'input> + 'a)) { self.deref().enter(listener) }
    fn exit(&self, listener: &mut (dyn ZserioParserListener<'input> + 'a)) { self.deref().exit(listener) }
}
...
impl<'input> ExpressionContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ExpressionContextAll<'input>> {
		Rc::new(
...
pub trait ExpressionContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<ExpressionContextExt<'input>>{
...
pub trait BitwiseXorExpressionContextAttrs<'input>: ZserioParserContext<'input>{
	...
	fn XOR(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for BitwiseXorExpressionContext<'input>{
	fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for BitwiseXorExpressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
pub type DotExpressionContext<'input> = BaseParserRuleContext<'input,DotExpressionContextExt<'input>>;
...
pub trait DotExpressionContextAttrs<'input>: ZserioParserContext<'input>{
	...
	fn DOT(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for DotExpressionContext<'input>{
	fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input> DotExpressionContextExt<'input>{
	fn new(ctx: &dyn ExpressionContextAttrs<'input>) -> Rc<ExpressionContextAll<'input>>  {
		Rc::new(
			ExpressionContextAll::DotExpressionContext(
				BaseParserRuleContext::copy_from(ctx,DotExpressionContextExt{
					operator:None, 
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
...
pub type ValueofExpressionContext<'input> = BaseParserRuleContext<'input,ValueofExpressionContextExt<'input>>;
...
pub trait ValueofExpressionContextAttrs<'input>: ZserioParserContext<'input>{
	...
	fn VALUEOF(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for ValueofExpressionContext<'input>{
	fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for ValueofExpressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> ValueofExpressionContextExt<'input>{
	fn new(ctx: &dyn ExpressionContextAttrs<'input>) -> Rc<ExpressionContextAll<'input>>  {
		Rc::new(
			ExpressionContextAll::ValueofExpressionContext(
				BaseParserRuleContext::copy_from(ctx,ValueofExpressionContextExt{
					operator:None, 
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
...
pub trait ShiftExpressionContextAttrs<'input>: ZserioParserContext<'input>{
	...
	fn GT_all(&self) -> Vec<Rc<TerminalNode<'input,ZserioParserContextType>>>  where Self:Sized{
		self.get_tokens(GT)
	}
	...
	fn GT(&self, i: usize) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
		self.get_token(GT, i)
	}
	...
	fn LSHIFT(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for ShiftExpressionContext<'input>{
	fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for ShiftExpressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> ShiftExpressionContextExt<'input>{
	fn new(ctx: &dyn ExpressionContextAttrs<'input>) -> Rc<ExpressionContextAll<'input>>  {
		Rc::new(
			ExpressionContextAll::ShiftExpressionContext(
...
pub type ArrayExpressionContext<'input> = BaseParserRuleContext<'input,ArrayExpressionContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for ArrayExpressionContext<'input>{
	fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for ArrayExpressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> ArrayExpressionContextExt<'input>{
	fn new(ctx: &dyn ExpressionContextAttrs<'input>) -> Rc<ExpressionContextAll<'input>>  {
		Rc::new(
			ExpressionContextAll::ArrayExpressionContext(
				BaseParserRuleContext::copy_from(ctx,ArrayExpressionContextExt{
					operator:None, 
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
...
pub type NumbitsExpressionContext<'input> = BaseParserRuleContext<'input,NumbitsExpressionContextExt<'input>>;
...
pub trait NumbitsExpressionContextAttrs<'input>: ZserioParserContext<'input>{
	...
	fn NUMBITS(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for NumbitsExpressionContext<'input>{
	fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for NumbitsExpressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> NumbitsExpressionContextExt<'input>{
	fn new(ctx: &dyn ExpressionContextAttrs<'input>) -> Rc<ExpressionContextAll<'input>>  {
		Rc::new(
			ExpressionContextAll::NumbitsExpressionContext(
				BaseParserRuleContext::copy_from(ctx,NumbitsExpressionContextExt{
					operator:None, 
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
...
pub trait AdditiveExpressionContextAttrs<'input>: ZserioParserContext<'input>{
	...
	fn PLUS(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
		self.get_token(PLUS, 0)
	}
	/// Retrieves first TerminalNode corresponding to token MINUS
	/// Returns `None` if there is no child corresponding to token MINUS
	fn MINUS(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for AdditiveExpressionContext<'input>{
	fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for AdditiveExpressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
pub trait RelationalExpressionContextAttrs<'input>: ZserioParserContext<'input>{
	...
	fn LE(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
		self.get_token(LE, 0)
	}
	/// Retrieves first TerminalNode corresponding to token GT
	/// Returns `None` if there is no child corresponding to token GT
	...
	fn GE(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
		self.get_token(GE, 0)
	}
}
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for RelationalExpressionContext<'input>{
	fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for RelationalExpressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> RelationalExpressionContextExt<'input>{
	fn new(ctx: &dyn ExpressionContextAttrs<'input>) -> Rc<ExpressionContextAll<'input>>  {
		Rc::new(
			ExpressionContextAll::RelationalExpressionContext(
...
pub type LengthofExpressionContext<'input> = BaseParserRuleContext<'input,LengthofExpressionContextExt<'input>>;
...
pub trait LengthofExpressionContextAttrs<'input>: ZserioParserContext<'input>{
	...
	fn LENGTHOF(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for LengthofExpressionContext<'input>{
	fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for LengthofExpressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> LengthofExpressionContextExt<'input>{
	fn new(ctx: &dyn ExpressionContextAttrs<'input>) -> Rc<ExpressionContextAll<'input>>  {
		Rc::new(
			ExpressionContextAll::LengthofExpressionContext(
				BaseParserRuleContext::copy_from(ctx,LengthofExpressionContextExt{
					operator:None, 
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for IdentifierExpressionContext<'input>{
	fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for IdentifierExpressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> IdentifierExpressionContextExt<'input>{
	fn new(ctx: &dyn ExpressionContextAttrs<'input>) -> Rc<ExpressionContextAll<'input>>  {
		Rc::new(
			ExpressionContextAll::IdentifierExpressionContext(
...
pub trait MultiplicativeExpressionContextAttrs<'input>: ZserioParserContext<'input>{
	...
	fn DIVIDE(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
	...
	fn MODULO(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for MultiplicativeExpressionContext<'input>{
	fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for MultiplicativeExpressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
pub trait LogicalOrExpressionContextAttrs<'input>: ZserioParserContext<'input>{
	...
	fn LOGICAL_OR(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for LogicalOrExpressionContext<'input>{
	fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for LogicalOrExpressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
pub type IsSetExpressionContext<'input> = BaseParserRuleContext<'input,IsSetExpressionContextExt<'input>>;
...
pub trait IsSetExpressionContextAttrs<'input>: ZserioParserContext<'input>{
	...
	fn COMMA(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
	...
	fn ISSET(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for IsSetExpressionContext<'input>{
	fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for IsSetExpressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> IsSetExpressionContextExt<'input>{
	fn new(ctx: &dyn ExpressionContextAttrs<'input>) -> Rc<ExpressionContextAll<'input>>  {
		Rc::new(
			ExpressionContextAll::IsSetExpressionContext(
				BaseParserRuleContext::copy_from(ctx,IsSetExpressionContextExt{
					operator:None, 
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
...
pub trait BitwiseOrExpressionContextAttrs<'input>: ZserioParserContext<'input>{
	...
	fn OR(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
		self.get_token(OR, 0)
	}
}
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for BitwiseOrExpressionContext<'input>{
	fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for BitwiseOrExpressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for ParenthesizedExpressionContext<'input>{
	fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for ParenthesizedExpressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> ParenthesizedExpressionContextExt<'input>{
	fn new(ctx: &dyn ExpressionContextAttrs<'input>) -> Rc<ExpressionContextAll<'input>>  {
		Rc::new(
			ExpressionContextAll::ParenthesizedExpressionContext(
...
pub trait BitwiseAndExpressionContextAttrs<'input>: ZserioParserContext<'input>{
	...
	fn AND(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for BitwiseAndExpressionContext<'input>{
	fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for BitwiseAndExpressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
pub trait EqualityExpressionContextAttrs<'input>: ZserioParserContext<'input>{
	...
	fn EQ(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
		self.get_token(EQ, 0)
	}
	/// Retrieves first TerminalNode corresponding to token NE
	/// Returns `None` if there is no child corresponding to token NE
	fn NE(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
		self.get_token(NE, 0)
	}
}
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for EqualityExpressionContext<'input>{
	fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for EqualityExpressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
pub trait LogicalAndExpressionContextAttrs<'input>: ZserioParserContext<'input>{
	...
	fn LOGICAL_AND(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for LogicalAndExpressionContext<'input>{
	fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for LogicalAndExpressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for FunctionCallExpressionContext<'input>{
	fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for FunctionCallExpressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> FunctionCallExpressionContextExt<'input>{
	fn new(ctx: &dyn ExpressionContextAttrs<'input>) -> Rc<ExpressionContextAll<'input>>  {
		Rc::new(
			ExpressionContextAll::FunctionCallExpressionContext(
				BaseParserRuleContext::copy_from(ctx,FunctionCallExpressionContextExt{
					operator:None, 
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
...
pub trait IndexExpressionContextAttrs<'input>: ZserioParserContext<'input>{
	...
	fn INDEX(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for IndexExpressionContext<'input>{
	fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for IndexExpressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
pub trait UnaryExpressionContextAttrs<'input>: ZserioParserContext<'input>{
	...
	fn BANG(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
	...
	fn TILDE(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for UnaryExpressionContext<'input>{
	fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for UnaryExpressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for LiteralExpressionContext<'input>{
	fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for LiteralExpressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
pub type TernaryExpressionContext<'input> = BaseParserRuleContext<'input,TernaryExpressionContextExt<'input>>;
...
pub trait TernaryExpressionContextAttrs<'input>: ZserioParserContext<'input>{
	...
	fn QUESTIONMARK(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for TernaryExpressionContext<'input>{
	fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for TernaryExpressionContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> TernaryExpressionContextExt<'input>{
	fn new(ctx: &dyn ExpressionContextAttrs<'input>) -> Rc<ExpressionContextAll<'input>>  {
		Rc::new(
			ExpressionContextAll::TernaryExpressionContext(
				BaseParserRuleContext::copy_from(ctx,TernaryExpressionContextExt{
					operator:None, 
        			base: ctx.borrow().clone(),
        			ph:PhantomData
				})
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<ExpressionContextAll<'input>>,ANTLRError> {
		...
		recog.base.enter_recursion_rule(_localctx.clone(), 106, RULE_expression, _p);
			...
			match recog.base.input.la(1) {
			 LPAREN 
				=> {
					...
					if let ExpressionContextAll::ParenthesizedExpressionContext(ctx) = cast_mut::<_,ExpressionContextAll >(&mut _localctx){
			 ...
			 ISSET 
				=> {
					...
					if let ExpressionContextAll::IsSetExpressionContext(ctx) = cast_mut::<_,ExpressionContextAll >(&mut _localctx){
					ctx.operator = Some(tmp.clone()); } else {unreachable!("cant cast");}  
			 ...
			 LENGTHOF 
				=> {
					...
					if let ExpressionContextAll::LengthofExpressionContext(ctx) = cast_mut::<_,ExpressionContextAll >(&mut _localctx){
					ctx.operator = Some(tmp.clone()); } else {unreachable!("cant cast");}  
			 ...
			 VALUEOF 
				=> {
					...
					if let ExpressionContextAll::ValueofExpressionContext(ctx) = cast_mut::<_,ExpressionContextAll >(&mut _localctx){
					ctx.operator = Some(tmp.clone()); } else {unreachable!("cant cast");}  
			 ...
			 NUMBITS 
				=> {
					...
					if let ExpressionContextAll::NumbitsExpressionContext(ctx) = cast_mut::<_,ExpressionContextAll >(&mut _localctx){
					ctx.operator = Some(tmp.clone()); } else {unreachable!("cant cast");}  
			 ...
			 BANG | MINUS | PLUS | TILDE 
				=> {
					...
					_la = recog.base.input.la(1);
					if { !((((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << BANG) | (1usize << MINUS) | (1usize << PLUS) | (1usize << TILDE))) != 0)) } {
			 ...
			 BOOL_LITERAL | STRING_LITERAL | BINARY_LITERAL | OCTAL_LITERAL | HEXADECIMAL_LITERAL |
				...
				if _alt==1 {
					...
					match  recog.interpreter.adaptive_predict(59,&mut recog.base)? {
						1 =>{
							...
							ctx.operator = recog.base.input.lt(1).cloned(); } else {unreachable!("cant cast");} 
							_la = recog.base.input.la(1);
							if { !((((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << DIVIDE) | (1usize << MODULO) | (1usize << MULTIPLY))) != 0)) } {
								let tmp = recog.err_handler.recover_inline(&mut recog.base)?;
								if let ExpressionContextAll::MultiplicativeExpressionContext(ctx) = cast_mut::<_,ExpressionContextAll >(&mut _localctx){
								ctx.operator = Some(tmp.clone()); } else {unreachable!("cant cast");}  
					...
					,
						3 =>{
							{
							/*recRuleLabeledAltStartAction*/
							let mut tmp = ShiftExpressionContextExt::new(&**ExpressionContextExt::new(_parentctx.clone(), _parentState));
							recog.push_new_recursion_context(tmp.clone(), _startState, RULE_expression);
							_localctx = tmp;
							...
							match recog.base.input.la(1) {
							 LSHIFT 
								=> {
									...
									let tmp = recog.base.match_token(LSHIFT,&mut recog.err_handler)?;
							 ...
							 GT 
								=> {
									...
									let tmp = recog.base.match_token(GT,&mut recog.err_handler)?;
									if let ExpressionContextAll::ShiftExpressionContext(ctx) = cast_mut::<_,ExpressionContextAll >(&mut _localctx){
									ctx.operator = Some(tmp.clone()); } else {unreachable!("cant cast");}  
					...
					,
						4 =>{
							{
							/*recRuleLabeledAltStartAction*/
							let mut tmp = RelationalExpressionContextExt::new(&**ExpressionContextExt::new(_parentctx.clone(), _parentState));
							recog.push_new_recursion_context(tmp.clone(), _startState, RULE_expression);
							_localctx = tmp;
							...
							ctx.operator = recog.base.input.lt(1).cloned(); } else {unreachable!("cant cast");} 
							_la = recog.base.input.la(1);
							if { !((((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << GE) | (1usize << GT) | (1usize << LE) | (1usize << LT))) != 0)) } {
								let tmp = recog.err_handler.recover_inline(&mut recog.base)?;
								if let ExpressionContextAll::RelationalExpressionContext(ctx) = cast_mut::<_,ExpressionContextAll >(&mut _localctx){
								ctx.operator = Some(tmp.clone()); } else {unreachable!("cant cast");}  
					...
					,
						7 =>{
							...
							let tmp = recog.base.match_token(XOR,&mut recog.err_handler)?;
					...
					,
						11 =>{
							{
							/*recRuleLabeledAltStartAction*/
							let mut tmp = TernaryExpressionContextExt::new(&**ExpressionContextExt::new(_parentctx.clone(), _parentState));
							recog.push_new_recursion_context(tmp.clone(), _startState, RULE_expression);
							_localctx = tmp;
							...
							if let ExpressionContextAll::TernaryExpressionContext(ctx) = cast_mut::<_,ExpressionContextAll >(&mut _localctx){
							ctx.operator = Some(tmp.clone()); } else {unreachable!("cant cast");}  
					...
					,
						12 =>{
							{
							/*recRuleLabeledAltStartAction*/
							let mut tmp = FunctionCallExpressionContextExt::new(&**ExpressionContextExt::new(_parentctx.clone(), _parentState));
							recog.push_new_recursion_context(tmp.clone(), _startState, RULE_expression);
							_localctx = tmp;
							...
							let tmp = recog.base.match_token(RPAREN,&mut recog.err_handler)?;
							if let ExpressionContextAll::FunctionCallExpressionContext(ctx) = cast_mut::<_,ExpressionContextAll >(&mut _localctx){
							ctx.operator = Some(tmp.clone()); } else {unreachable!("cant cast");}  
					...
					,
						13 =>{
							{
							/*recRuleLabeledAltStartAction*/
							let mut tmp = ArrayExpressionContextExt::new(&**ExpressionContextExt::new(_parentctx.clone(), _parentState));
							recog.push_new_recursion_context(tmp.clone(), _startState, RULE_expression);
							_localctx = tmp;
							...
							if let ExpressionContextAll::ArrayExpressionContext(ctx) = cast_mut::<_,ExpressionContextAll >(&mut _localctx){
							ctx.operator = Some(tmp.clone()); } else {unreachable!("cant cast");}  
					...
					,
						14 =>{
							{
							/*recRuleLabeledAltStartAction*/
							let mut tmp = DotExpressionContextExt::new(&**ExpressionContextExt::new(_parentctx.clone(), _parentState));
							recog.push_new_recursion_context(tmp.clone(), _startState, RULE_expression);
							_localctx = tmp;
							...
							if let ExpressionContextAll::DotExpressionContext(ctx) = cast_mut::<_,ExpressionContextAll >(&mut _localctx){
							ctx.operator = Some(tmp.clone()); } else {unreachable!("cant cast");}  
...
impl<'input> LiteralContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<LiteralContextAll<'input>> {
		Rc::new(
...
pub trait LiteralContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<LiteralContextExt<'input>>{
...
fn BINARY_LITERAL(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn OCTAL_LITERAL(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn DECIMAL_LITERAL(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn HEXADECIMAL_LITERAL(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn BOOL_LITERAL(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn FLOAT_LITERAL(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn DOUBLE_LITERAL(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<LiteralContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			_la = recog.base.input.la(1);
			if { !(((((_la - 103)) & !0x3f) == 0 && ((1usize << (_la - 103)) & ((1usize << (BOOL_LITERAL - 103)) | (1usize << (STRING_LITERAL - 103)) | (1usize << (BINARY_LITERAL - 103)) | (1usize << (OCTAL_LITERAL - 103)) | (1usize << (HEXADECIMAL_LITERAL - 103)) | (1usize << (DOUBLE_LITERAL - 103)) | (1usize << (FLOAT_LITERAL - 103)) | (1usize << (DECIMAL_LITERAL - 103)))) != 0)) } {
				recog.err_handler.recover_inline(&mut recog.base)?;
...
impl<'input> IdContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<IdContextAll<'input>> {
		Rc::new(
...
pub trait IdContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<IdContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token ID
/// Returns `None` if there is no child corresponding to token ID
fn ID(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
	self.get_token(ID, 0)
}
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for TypeReferenceContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> TypeReferenceContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<TypeReferenceContextAll<'input>> {
		Rc::new(
...
pub trait TypeReferenceContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<TypeReferenceContextExt<'input>>{

fn builtinType(&self) -> Option<Rc<BuiltinTypeContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn qualifiedName(&self) -> Option<Rc<QualifiedNameContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn templateArguments(&self) -> Option<Rc<TemplateArgumentsContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<TypeReferenceContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 112, RULE_typeReference);
...
pub type TypeInstantiationContext<'input> = BaseParserRuleContext<'input,TypeInstantiationContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for TypeInstantiationContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for TypeInstantiationContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for TypeInstantiationContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_typeInstantiation }
...
impl<'input> TypeInstantiationContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<TypeInstantiationContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,TypeInstantiationContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait TypeInstantiationContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<TypeInstantiationContextExt<'input>>{
...
fn dynamicLengthArgument(&self) -> Option<Rc<DynamicLengthArgumentContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn typeInstantiation(&mut self,)
	-> Result<Rc<TypeInstantiationContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = TypeInstantiationContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 114, RULE_typeInstantiation);
...
impl<'input> CustomRuleContext<'input> for BuiltinTypeContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_builtinType }
...
impl<'input> BuiltinTypeContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<BuiltinTypeContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,BuiltinTypeContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait BuiltinTypeContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<BuiltinTypeContextExt<'input>>{

fn intType(&self) -> Option<Rc<IntTypeContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn varintType(&self) -> Option<Rc<VarintTypeContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn fixedBitFieldType(&self) -> Option<Rc<FixedBitFieldTypeContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn dynamicBitFieldType(&self) -> Option<Rc<DynamicBitFieldTypeContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn boolType(&self) -> Option<Rc<BoolTypeContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
fn externType(&self) -> Option<Rc<ExternTypeContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn bytesType(&self) -> Option<Rc<BytesTypeContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn builtinType(&mut self,)
	-> Result<Rc<BuiltinTypeContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = BuiltinTypeContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 116, RULE_builtinType);
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for QualifiedNameContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> QualifiedNameContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<QualifiedNameContextAll<'input>> {
		Rc::new(
...
pub trait QualifiedNameContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<QualifiedNameContextExt<'input>>{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<QualifiedNameContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 118, RULE_qualifiedName);
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for TypeArgumentsContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input> TypeArgumentsContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<TypeArgumentsContextAll<'input>> {
		Rc::new(
...
pub trait TypeArgumentsContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<TypeArgumentsContextExt<'input>>{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<TypeArgumentsContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 120, RULE_typeArguments);
...
impl<'input> TypeArgumentContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<TypeArgumentContextAll<'input>> {
		Rc::new(
...
pub trait TypeArgumentContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<TypeArgumentContextExt<'input>>{
...
fn EXPLICIT(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<TypeArgumentContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 122, RULE_typeArgument);
...
pub type DynamicLengthArgumentContext<'input> = BaseParserRuleContext<'input,DynamicLengthArgumentContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for DynamicLengthArgumentContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for DynamicLengthArgumentContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for DynamicLengthArgumentContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_dynamicLengthArgument }
...
impl<'input> DynamicLengthArgumentContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<DynamicLengthArgumentContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,DynamicLengthArgumentContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait DynamicLengthArgumentContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<DynamicLengthArgumentContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn dynamicLengthArgument(&mut self,)
	-> Result<Rc<DynamicLengthArgumentContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = DynamicLengthArgumentContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 124, RULE_dynamicLengthArgument);
...
impl<'input> IntTypeContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<IntTypeContextAll<'input>> {
		Rc::new(
...
pub trait IntTypeContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<IntTypeContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token INT8
/// Returns `None` if there is no child corresponding to token INT8
fn INT8(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn INT16(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn INT32(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn INT64(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn UINT8(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn UINT16(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn UINT32(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn UINT64(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<IntTypeContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			_la = recog.base.input.la(1);
			if { !(((((_la - 54)) & !0x3f) == 0 && ((1usize << (_la - 54)) & ((1usize << (INT16 - 54)) | (1usize << (INT32 - 54)) | (1usize << (INT64 - 54)) | (1usize << (INT8 - 54)) | (1usize << (UINT16 - 54)) | (1usize << (UINT32 - 54)) | (1usize << (UINT64 - 54)) | (1usize << (UINT8 - 54)))) != 0)) } {
				recog.err_handler.recover_inline(&mut recog.base)?;
...
impl<'input> CustomRuleContext<'input> for VarintTypeContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_varintType }
...
impl<'input> VarintTypeContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<VarintTypeContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,VarintTypeContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait VarintTypeContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<VarintTypeContextExt<'input>>{
...
fn VARINT(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn VARINT16(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn VARINT32(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn VARINT64(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn VARSIZE(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn VARUINT(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn VARUINT16(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn VARUINT32(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn VARUINT64(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn varintType(&mut self,)
	-> Result<Rc<VarintTypeContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = VarintTypeContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 128, RULE_varintType);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			_la = recog.base.input.la(1);
			if { !(((((_la - 88)) & !0x3f) == 0 && ((1usize << (_la - 88)) & ((1usize << (VARINT - 88)) | (1usize << (VARINT16 - 88)) | (1usize << (VARINT32 - 88)) | (1usize << (VARINT64 - 88)) | (1usize << (VARSIZE - 88)) | (1usize << (VARUINT - 88)) | (1usize << (VARUINT16 - 88)) | (1usize << (VARUINT32 - 88)) | (1usize << (VARUINT64 - 88)))) != 0)) } {
				recog.err_handler.recover_inline(&mut recog.base)?;
...
pub type FixedBitFieldTypeContext<'input> = BaseParserRuleContext<'input,FixedBitFieldTypeContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for FixedBitFieldTypeContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for FixedBitFieldTypeContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for FixedBitFieldTypeContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_fixedBitFieldType }
...
impl<'input> FixedBitFieldTypeContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<FixedBitFieldTypeContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,FixedBitFieldTypeContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait FixedBitFieldTypeContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<FixedBitFieldTypeContextExt<'input>>{
...
fn BIT_FIELD(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn INT_FIELD(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn fixedBitFieldType(&mut self,)
	-> Result<Rc<FixedBitFieldTypeContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = FixedBitFieldTypeContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 130, RULE_fixedBitFieldType);
...
pub type DynamicBitFieldTypeContext<'input> = BaseParserRuleContext<'input,DynamicBitFieldTypeContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn ZserioParserListener<'input> + 'a> for DynamicBitFieldTypeContext<'input>{
		fn enter(&self,listener: &mut (dyn ZserioParserListener<'input> + 'a)) {
			listener.enter_every_rule(self);
...
impl<'input,'a> Visitable<dyn ZserioParserVisitor<'input> + 'a> for DynamicBitFieldTypeContext<'input>{
	fn accept(&self,visitor: &mut (dyn ZserioParserVisitor<'input> + 'a)) {
...
impl<'input> CustomRuleContext<'input> for DynamicBitFieldTypeContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_dynamicBitFieldType }
...
impl<'input> DynamicBitFieldTypeContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<DynamicBitFieldTypeContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,DynamicBitFieldTypeContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait DynamicBitFieldTypeContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<DynamicBitFieldTypeContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn dynamicBitFieldType(&mut self,)
	-> Result<Rc<DynamicBitFieldTypeContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = DynamicBitFieldTypeContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 132, RULE_dynamicBitFieldType);
...
impl<'input> CustomRuleContext<'input> for BoolTypeContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_boolType }
...
impl<'input> BoolTypeContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<BoolTypeContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,BoolTypeContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait BoolTypeContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<BoolTypeContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token BOOL
/// Returns `None` if there is no child corresponding to token BOOL
fn BOOL(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn boolType(&mut self,)
	-> Result<Rc<BoolTypeContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> StringTypeContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<StringTypeContextAll<'input>> {
		Rc::new(
...
pub trait StringTypeContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<StringTypeContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token STRING
/// Returns `None` if there is no child corresponding to token STRING
fn STRING(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<StringTypeContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 136, RULE_stringType);
...
impl<'input> FloatTypeContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<FloatTypeContextAll<'input>> {
		Rc::new(
...
pub trait FloatTypeContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<FloatTypeContextExt<'input>>{
...
fn FLOAT16(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn FLOAT32(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
fn FLOAT64(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<FloatTypeContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 138, RULE_floatType);
		...
		let result: Result<(), ANTLRError> = (|| {
			...
			_la = recog.base.input.la(1);
			if { !(((((_la - 44)) & !0x3f) == 0 && ((1usize << (_la - 44)) & ((1usize << (FLOAT16 - 44)) | (1usize << (FLOAT32 - 44)) | (1usize << (FLOAT64 - 44)))) != 0)) } {
				recog.err_handler.recover_inline(&mut recog.base)?;
...
impl<'input> CustomRuleContext<'input> for ExternTypeContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_externType }
...
impl<'input> ExternTypeContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ExternTypeContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,ExternTypeContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait ExternTypeContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<ExternTypeContextExt<'input>>{
...
fn EXTERN(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn externType(&mut self,)
	-> Result<Rc<ExternTypeContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = ExternTypeContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 140, RULE_externType);
...
impl<'input> CustomRuleContext<'input> for BytesTypeContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = ZserioParserContextType;
	fn get_rule_index(&self) -> usize { RULE_bytesType }
...
impl<'input> BytesTypeContextExt<'input>{
	fn new(parent: Option<Rc<dyn ZserioParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<BytesTypeContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,BytesTypeContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait BytesTypeContextAttrs<'input>: ZserioParserContext<'input> + BorrowMut<BytesTypeContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token BYTES
/// Returns `None` if there is no child corresponding to token BYTES
fn BYTES(&self) -> Option<Rc<TerminalNode<'input,ZserioParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn bytesType(&mut self,)
	-> Result<Rc<BytesTypeContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = BytesTypeContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 142, RULE_bytesType);
...
const _serializedATN:&'static str =
	...
	\x74\u{30f}\x04\x02\x09\x02\x04\x03\x09\x03\x04\x04\x09\x04\x04\x05\x09\
	...
	\u{119}\x0a\x0e\x03\x0e\x03\x0e\x05\x0e\u{11d}\x0a\x0e\x03\x0e\x05\x0e\u{120}\
	\x0a\x0e\x03\x0e\x05\x0e\u{123}\x0a\x0e\x03\x0e\x03\x0e\x03\x0f\x03\x0f\
	\x03\x0f\x03\x0f\x03\x0f\x03\x0f\x03\x10\x03\x10\x03\x10\x03\x11\x05\x11\
	\u{131}\x0a\x11\x03\x11\x05\x11\u{134}\x0a\x11\x03\x11\x03\x11\x03\x11\x05\
	\x11\u{139}\x0a\x11\x03\x12\x03\x12\x05\x12\u{13d}\x0a\x12\x03\x12\x03\x12\
	\x03\x13\x03\x13\x03\x13\x03\x14\x03\x14\x03\x14\x03\x15\x03\x15\x03\x15\
	\x03\x16\x03\x16\x03\x16\x05\x16\u{14d}\x0a\x16\x03\x16\x03\x16\x03\x16\
	\x03\x16\x03\x16\x07\x16\u{154}\x0a\x16\x0c\x16\x0e\x16\u{157}\x0b\x16\x03\
	\x16\x05\x16\u{15a}\x0a\x16\x03\x16\x07\x16\u{15d}\x0a\x16\x0c\x16\x0e\x16\
	\u{160}\x0b\x16\x03\x16\x03\x16\x03\x16\x03\x17\x06\x17\u{166}\x0a\x17\x0d\
	\x17\x0e\x17\u{167}\x03\x17\x05\x17\u{16b}\x0a\x17\x03\x17\x03\x17\x03\x18\
	\x03\x18\x03\x18\x03\x18\x03\x19\x03\x19\x03\x19\x05\x19\u{176}\x0a\x19\
	\x03\x19\x03\x19\x03\x1a\x03\x1a\x05\x1a\u{17c}\x0a\x1a\x03\x1b\x03\x1b\
	\x03\x1b\x05\x1b\u{181}\x0a\x1b\x03\x1b\x05\x1b\u{184}\x0a\x1b\x03\x1b\x03\
	\x1b\x07\x1b\u{188}\x0a\x1b\x0c\x1b\x0e\x1b\u{18b}\x0b\x1b\x03\x1b\x07\x1b\
	\u{18e}\x0a\x1b\x0c\x1b\x0e\x1b\u{191}\x0b\x1b\x03\x1b\x03\x1b\x03\x1b\x03\
	\x1c\x03\x1c\x03\x1c\x03\x1d\x03\x1d\x03\x1d\x03\x1d\x03\x1d\x03\x1d\x03\
	\x1d\x07\x1d\u{1a0}\x0a\x1d\x0c\x1d\x0e\x1d\u{1a3}\x0b\x1d\x03\x1d\x05\x1d\
	\u{1a6}\x0a\x1d\x03\x1d\x03\x1d\x03\x1d\x03\x1e\x03\x1e\x03\x1e\x05\x1e\
	\u{1ae}\x0a\x1e\x03\x1f\x03\x1f\x03\x1f\x03\x1f\x03\x1f\x03\x1f\x03\x1f\
	\x07\x1f\u{1b7}\x0a\x1f\x0c\x1f\x0e\x1f\u{1ba}\x0b\x1f\x03\x1f\x05\x1f\u{1bd}\
	\x0a\x1f\x03\x1f\x03\x1f\x03\x1f\x03\x20\x03\x20\x03\x20\x05\x20\u{1c5}\
	\x0a\x20\x03\x21\x03\x21\x03\x21\x05\x21\u{1ca}\x0a\x21\x03\x21\x03\x21\
	\x05\x21\u{1ce}\x0a\x21\x03\x21\x03\x21\x07\x21\u{1d2}\x0a\x21\x0c\x21\x0e\
	\x21\u{1d5}\x0b\x21\x03\x21\x05\x21\u{1d8}\x0a\x21\x03\x21\x05\x21\u{1db}\
	\x0a\x21\x03\x21\x03\x21\x03\x21\x03\x22\x05\x22\u{1e1}\x0a\x22\x03\x22\
	\x03\x22\x03\x22\x05\x22\u{1e6}\x0a\x22\x03\x22\x03\x22\x03\x23\x03\x23\
	\x03\x23\x03\x24\x03\x24\x03\x24\x03\x25\x03\x25\x03\x25\x03\x26\x03\x26\
	\x03\x26\x03\x26\x06\x26\u{1f7}\x0a\x26\x0d\x26\x0e\x26\u{1f8}\x03\x26\x03\
	\x26\x03\x26\x03\x27\x03\x27\x03\x27\x03\x27\x03\x28\x03\x28\x03\x28\x03\
	\x28\x07\x28\u{206}\x0a\x28\x0c\x28\x0e\x28\u{209}\x0b\x28\x03\x28\x03\x28\
	\x03\x28\x03\x29\x03\x29\x03\x29\x03\x29\x03\x29\x03\x29\x03\x29\x03\x2a\
	\x03\x2a\x03\x2a\x03\x2a\x07\x2a\u{219}\x0a\x2a\x0c\x2a\x0e\x2a\u{21c}\x0b\
	\x2a\x03\x2a\x03\x2a\x03\x2a\x03\x2b\x03\x2b\x03\x2b\x03\x2b\x03\x2b\x03\
	\x2c\x05\x2c\u{227}\x0a\x2c\x03\x2c\x03\x2c\x03\x2c\x03\x2c\x03\x2c\x03\
	\x2d\x03\x2d\x03\x2d\x03\x2d\x03\x2d\x03\x2d\x03\x2d\x03\x2e\x03\x2e\x03\
	\x2f\x03\x2f\x03\x30\x03\x30\x03\x30\x03\x30\x03\x30\x03\x30\x03\x31\x03\
	\x31\x03\x31\x03\x31\x07\x31\u{243}\x0a\x31\x0c\x31\x0e\x31\u{246}\x0b\x31\
	\x03\x31\x03\x31\x03\x32\x03\x32\x03\x32\x03\x33\x03\x33\x03\x33\x03\x33\
	\x07\x33\u{251}\x0a\x33\x0c\x33\x0e\x33\u{254}\x0b\x33\x03\x33\x03\x33\x03\
	\x34\x03\x34\x03\x34\x03\x34\x07\x34\u{25c}\x0a\x34\x0c\x34\x0e\x34\u{25f}\
	\x0b\x34\x03\x34\x03\x34\x03\x35\x03\x35\x03\x36\x03\x36\x03\x36\x03\x36\
	...
	\x03\x37\x03\x37\x03\x37\x03\x37\x03\x37\x03\x37\x03\x37\x03\x37\x03\x37\
	\x03\x37\x03\x37\x03\x37\x03\x37\x03\x37\x03\x37\x05\x37\u{28a}\x0a\x37\
	\x03\x37\x03\x37\x03\x37\x03\x37\x03\x37\x03\x37\x03\x37\x03\x37\x03\x37