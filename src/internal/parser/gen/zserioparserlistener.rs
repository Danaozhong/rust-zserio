...
pub trait ZserioParserListener<'input>: ParseTreeListener<'input, ZserioParserContextType> {
     ...
     * @param ctx the parse tree
     */
    fn enter_compatibilityVersionDirective(
        &mut self,
        _ctx: &CompatibilityVersionDirectiveContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_compatibilityVersionDirective(
        &mut self,
        _ctx: &CompatibilityVersionDirectiveContext<'input>,
    ) {
    }
     ...
     * @param ctx the parse tree
     */
    fn enter_sqlDatabaseFieldDefinition(
        &mut self,
        _ctx: &SqlDatabaseFieldDefinitionContext<'input>,
    ) {
    }
    /**
     ...
     * @param ctx the parse tree
     */
    fn exit_sqlDatabaseFieldDefinition(
        &mut self,
        _ctx: &SqlDatabaseFieldDefinitionContext<'input>,
    ) {
    }
