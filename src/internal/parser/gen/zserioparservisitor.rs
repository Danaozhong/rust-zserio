...
pub trait ZserioParserVisitor<'input>: ParseTreeVisitor<'input, ZserioParserContextType> {
     ...
     * @param ctx the parse tree
     */
    fn visit_compatibilityVersionDirective(
        &mut self,
        ctx: &CompatibilityVersionDirectiveContext<'input>,
    ) {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_sqlDatabaseFieldDefinition(
        &mut self,
        ctx: &SqlDatabaseFieldDefinitionContext<'input>,
    ) {
        self.visit_children(ctx)
    }
...
pub trait ZserioParserVisitorCompat<'input>:
    ParseTreeVisitorCompat<'input, Node = ZserioParserContextType>
{
    /**
     * Visit a parse tree produced by {@link ZserioParser#packageDeclaration}.
     * @param ctx the parse tree
    ...
    fn visit_packageNameDefinition(
        &mut self,
        ctx: &PackageNameDefinitionContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_ruleGroupDefinition(
        &mut self,
        ctx: &RuleGroupDefinitionContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_subtypeDeclaration(
        &mut self,
        ctx: &SubtypeDeclarationContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_structureDeclaration(
        &mut self,
        ctx: &StructureDeclarationContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_structureFieldDefinition(
        &mut self,
        ctx: &StructureFieldDefinitionContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_fieldOptionalClause(
        &mut self,
        ctx: &FieldOptionalClauseContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_choiceFieldDefinition(
        &mut self,
        ctx: &ChoiceFieldDefinitionContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_unionFieldDefinition(
        &mut self,
        ctx: &UnionFieldDefinitionContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_bitmaskDeclaration(
        &mut self,
        ctx: &BitmaskDeclarationContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_sqlTableDeclaration(
        &mut self,
        ctx: &SqlTableDeclarationContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_sqlTableFieldDefinition(
        &mut self,
        ctx: &SqlTableFieldDefinitionContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_sqlConstraintDefinition(
        &mut self,
        ctx: &SqlConstraintDefinitionContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_sqlDatabaseDefinition(
        &mut self,
        ctx: &SqlDatabaseDefinitionContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_serviceMethodDefinition(
        &mut self,
        ctx: &ServiceMethodDefinitionContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_pubsubMessageDefinition(
        &mut self,
        ctx: &PubsubMessageDefinitionContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_parameterDefinition(
        &mut self,
        ctx: &ParameterDefinitionContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_templateParameters(
        &mut self,
        ctx: &TemplateParametersContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_instantiateDeclaration(
        &mut self,
        ctx: &InstantiateDeclarationContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_lengthofExpression(
        &mut self,
        ctx: &LengthofExpressionContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_identifierExpression(
        &mut self,
        ctx: &IdentifierExpressionContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_functionCallExpression(
        &mut self,
        ctx: &FunctionCallExpressionContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    fn visit_dynamicLengthArgument(
        &mut self,
        ctx: &DynamicLengthArgumentContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
     ...
     * @param ctx the parse tree
     */
    fn visit_dynamicBitFieldType(
        &mut self,
        ctx: &DynamicBitFieldTypeContext<'input>,
    ) -> Self::Return {
        self.visit_children(ctx)
    }
    ...
    T: ZserioParserVisitorCompat<'input>,
{
    ...
    fn visit_compatibilityVersionDirective(
        ...
        let result =
            <Self as ZserioParserVisitorCompat>::visit_compatibilityVersionDirective(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
    }
    ...
    fn visit_sqlDatabaseFieldDefinition(
        ...
        let result =
            <Self as ZserioParserVisitorCompat>::visit_sqlDatabaseFieldDefinition(self, ctx);
        *<Self as ParseTreeVisitorCompat>::temp_result(self) = result;
    }
